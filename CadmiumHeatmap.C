void CadmiumHeatmap(){
  ...
  Long64_t nlines = T->ReadFile("Deltacount300_for_109.csv","sector:sec_x:sec_y:DeltaCount:partno");
  ...
  TH2D * h2 = new TH2D("hhD", "Heatmap of BeamProfile", 218, 0, 217, 20, 0, 19); 
  ntuple->Draw("sec_x:218-sec_y>>hhD","DeltaCount","colz");
